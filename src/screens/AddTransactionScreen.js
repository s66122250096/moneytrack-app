...
export function AddTransactionScreen({ navigation }) {
  ...
  const incomeCategories = ['เงินเดือน', 'โบนัส', 'ธุรกิจส่วนตัว', 'ของขวัญ', 'อื่นๆ'];
  const expenseCategories = ['อาหาร', 'ขนส่ง', 'ช้อปปิ้ง', 'ค่าเช่า', 'ค่าน้ำค่าไฟ', 'สุขภาพ', 'บันเทิง', 'อื่นๆ'];
...
const styles = StyleSheet.create({
  ...
  typeToggle: {
    ...
    padding: 6, marginBottom: 16, gap: 6,
  ...
  submitButton: {
    backgroundColor: '#10b981', borderRadius: 20, paddingVertical: 18, alignItems: 'center',
